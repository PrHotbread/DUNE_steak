...
`conda env create -f anodeVDenv.yml`

then : 

`conda activate anodeVDenv`
...
- [ ] [Set up project integrations](https://gitlab.in2p3.fr/jpinchau/dunesimanodevd/-/settings/integrations)
